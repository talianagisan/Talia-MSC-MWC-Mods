...
namespace Kekmet602T_MWC
{
    public class Kekmet602T_MWC : Mod
    {
        ...
        public Collider SideLightTrigCol, FrontLightTrigCol;
        ...
        private void Mod_OnLoad()
        {
            ...
            BrakePivotExisting = Kekmet.Find("LOD/Dashboard/Brake/Pivot").gameObject; // Finds brake pedal pivot made by topless. 
            ...
            SideLightTrigCol = SideLightTrigger.GetComponent<Collider>();
            FrontLightTrigCol = FrontLightTrigger.GetComponent<Collider>();
