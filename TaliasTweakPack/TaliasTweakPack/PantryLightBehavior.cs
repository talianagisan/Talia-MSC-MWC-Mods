...
{
    public class PantryLightBehavior : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            LightSwitchButton = MainTweakMod.PantrySwitchObj.transform.Find("lights_switch/lights_switch_button").gameObject;
            LightSwitchButton.transform.localEulerAngles = new Vector3(12f, 0f, 0f);

            SwitchSound = MainTweakMod.PantrySwitchObj.GetComponent<AudioSource>();
            SwitchTrigCol = MainTweakMod.PantrySwitchObj.GetComponent<SphereCollider>();
        ...
        void Update()
        {
            if (UnifiedRaycast.GetHit(SwitchTrigCol))
            {
                ...
                if (Input.GetKeyDown(KeyCode.Mouse0))
                {
                    ...
                    {
                        LightSwitchButton.transform.localEulerAngles = new Vector3(12f, 0f, 0f);
                        MainTweakMod.PantryLightObj.SetActive(false);
                        lightOn = false;
                    ...
                    else
                    {
                        ...
                        MainTweakMod.PantryLightObj.SetActive(true);
                        lightOn = true;
                    }
                    SwitchSound.Play();
                }
